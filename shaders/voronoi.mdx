---
title: 'Voronoi'
description: 'Animated cellular pattern with smooth customizable edges and glow effects'
---
...
import { createShader, voronoiFragmentShader } from '@paper-design/shaders';
