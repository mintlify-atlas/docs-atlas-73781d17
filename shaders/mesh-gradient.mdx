---
title: 'Mesh Gradient'
description: 'A flowing composition of color spots with organic distortion and animation'
---
...
import { createShader, meshGradientFragmentShader } from '@paper-design/shaders';
