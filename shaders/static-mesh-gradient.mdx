...
description: 'Multi-point mesh gradient with wave distortion and adjustable blend sharpness'
---
...
import { createShader, staticMeshGradientFragmentShader } from '@paper-design/shaders';
