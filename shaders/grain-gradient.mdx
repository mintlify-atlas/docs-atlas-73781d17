...
description: 'Multi-color gradients with grainy noise texture in 7 animated abstract forms'
---
...
import { createShader, grainGradientFragmentShader, GrainGradientShapes } from '@paper-design/shaders';
