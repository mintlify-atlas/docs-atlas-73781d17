...
description: 'Radial gradient with focal point control, shape distortion, and advanced mixing modes'
---
...
import { createShader, staticRadialGradientFragmentShader } from '@paper-design/shaders';
