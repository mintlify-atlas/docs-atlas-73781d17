---
title: 'Perlin Noise'
description: 'Classic animated 3D Perlin noise with exposed controls for octaves, persistence, and lacunarity'
---
...
import { createShader, perlinNoiseFragmentShader } from '@paper-design/shaders';
