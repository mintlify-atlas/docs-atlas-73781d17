---
title: 'Simplex Noise'
description: 'Multi-color gradient mapped into smooth animated curves built with Simplex noise'
---
...
import { createShader, simplexNoiseFragmentShader } from '@paper-design/shaders';
